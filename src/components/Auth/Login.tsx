    ...
    <div className="min-h-screen bg-zinc-950 flex items-center justify-center p-4 font-sans">
      <div className="w-full max-w-md">
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl overflow-hidden shadow-2xl shadow-emerald-500/5">
          <div className="p-8">
            <h2 className="text-xl font-bold text-zinc-100 mb-6">Access Terminal</h2>
            ...
            <div className="relative my-8">
              ...
              <div className="relative flex justify-center text-[10px] uppercase font-bold">
                <span className="bg-zinc-900 px-4 text-zinc-600 tracking-widest">Or continue with</span>
              </div>
            </div>
